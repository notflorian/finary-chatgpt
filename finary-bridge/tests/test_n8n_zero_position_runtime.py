...
def test_runtime_captures_complete_large_cli_evidence(runtime_image, tmp_path, monkeypatch, failed):
    exported = {
        ...
        "nodes": [
            {
                "id": "manual", "name": "Manual", "type": "n8n-nodes-base.manualTrigger",
                "typeVersion": 1, "position": [0, 0], "parameters": {},
            },
            {
                "id": "large", "name": "Large Evidence", "type": "n8n-nodes-base.code",
            ...
            {
                "id": "finish", "name": "Finish", "type": "n8n-nodes-base.code",
                "typeVersion": 2, "position": [400, 0],
                "parameters": {
                    "mode": "runOnceForAllItems",
                    "jsCode": "throw new Error('SYNTHETIC_FAILURE');"
                    if failed else "return [{json:{complete:true}}];",
                },
            },
        ],
        "connections": {
