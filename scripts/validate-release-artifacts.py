...
def archive_check(path, reference, app_files):
    if path.suffix == ".whl":
    ...
    assert content[notice_name] == (reference / 'LICENSE').read_bytes(), "Archive notice mismatch"
...
def validate(work):
    ...
    for artifact in (wheel, sdist):
        archive_check(artifact, fixture, app_files)
